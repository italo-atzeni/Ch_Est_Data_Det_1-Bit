...
% -------------------------------------------------------------------------
% Description: Eq. (24) --> Compute the MSE of the optimal scaled LS
%     estimator.
% -------------------------------------------------------------------------
% Author: Italo Atzeni
% Version: 1.0
...
function MSE_sls_prime=compute_MSE_sls_prime(K,rho,tau,Delta)

MSE_sls_prime=1-2/pi*rho*tau^2/((rho*K+1)*(tau+Delta));