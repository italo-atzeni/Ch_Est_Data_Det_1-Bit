...
% -------------------------------------------------------------------------
% Description: Eq. (34) --> Compute the MSE of the BLM estimator in the
%     limit of rho->infty with p=1_tau.
% -------------------------------------------------------------------------
% Author: Italo Atzeni
% Version: 1.0
...
function MSE_blm_lim_rho_p1=compute_MSE_blm_lim_rho_p1

MSE_blm_lim_rho_p1=1-2/pi;