...
% -------------------------------------------------------------------------
% Description: Eq. (12) --> Compute the MSE of the BLM estimator.
% -------------------------------------------------------------------------
% Author: Italo Atzeni
% Version: 1.0
...
function MSE_blm=compute_MSE_blm(K,rho,tau,delta)

MSE_blm=1-2/pi*rho*tau^2/(rho*K+1)*1/K*sum(1./(tau+delta));